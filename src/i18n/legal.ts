    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Formulário de feedback do addon", body: [
          "O formulário é opcional e exige login. Tratamos a mensagem para analisar ideias e melhorar o conceito do addon. Apenas a mensagem é obrigatória; não coletamos um endereço de resposta nem incluímos o e-mail da sua conta. O feedback não é publicado nem usado para busca de companheiros ou marketing.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Formularz opinii o dodatku", body: [
          "Korzystanie z formularza jest dobrowolne i wymaga logowania. Przetwarzamy wiadomość, aby rozpatrzyć pomysły i ulepszyć koncepcję dodatku. Wymagana jest tylko wiadomość; nie zbieramy adresu do odpowiedzi ani nie dołączamy e-maila z konta. Opinie nie są publikowane ani używane do dobierania graczy lub marketingu.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Addon feedback form", body: [
          "Using the feedback form is voluntary and requires sign-in. We process your message to review your ideas and improve the addon concept. Only the message is required; we do not collect a reply address or include your account email. Feedback is not published, used for matching or used for marketing.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Feedbackformular zum Addon", body: [
          "Die Nutzung des Feedbackformulars ist freiwillig und setzt eine Anmeldung voraus. Wir verarbeiten deine Nachricht, um deine Ideen auszuwerten und das Addon-Konzept weiterzuentwickeln. Nur die Nachricht ist erforderlich; wir erheben keine Antwortadresse und senden keine E-Mail-Adresse aus deinem Konto mit. Feedback wird nicht veröffentlicht, nicht für das Matching und nicht für Werbung verwendet.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Formulaire de retour sur l’addon", body: [
          "L’utilisation du formulaire est facultative et nécessite une connexion. Nous traitons ton message pour examiner tes idées et améliorer le concept de l’addon. Seul le message est requis ; aucune adresse de réponse n’est collectée et aucune adresse e-mail du compte n’est jointe. Les retours ne sont ni publiés ni utilisés pour le matching ou la publicité.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Formulario de comentarios sobre el addon", body: [
          "El formulario es voluntario y requiere iniciar sesión. Tratamos tu mensaje para revisar tus ideas y mejorar el concepto del addon. Solo el mensaje es obligatorio; no recogemos una dirección de respuesta ni incluimos el correo de tu cuenta. Los comentarios no se publican ni se utilizan para el matching o la publicidad.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Modulo di feedback sull’addon", body: [
          "L’uso del modulo è facoltativo e richiede l’accesso. Trattiamo il messaggio per esaminare le tue idee e migliorare il progetto dell’addon. È richiesto solo il messaggio; non raccogliamo un indirizzo di risposta né includiamo l’e-mail del tuo account. Il feedback non viene pubblicato né usato per il matching o la pubblicità.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Formulário de feedback sobre o addon", body: [
          "A utilização do formulário é voluntária e exige sessão iniciada. Tratamos a tua mensagem para analisar as tuas ideias e melhorar o conceito do addon. Apenas a mensagem é necessária; não recolhemos um endereço de resposta nem incluímos o e-mail da tua conta. O feedback não é publicado nem utilizado para o matching ou publicidade.",
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Форма отзывов об аддоне", body: [
          "Использование формы добровольно и требует входа в аккаунт. Мы обрабатываем сообщение, чтобы рассмотреть идеи и улучшить концепцию аддона. Обязательно только сообщение; мы не собираем адрес для ответа и не добавляем почту из аккаунта. Отзывы не публикуются и не используются для подбора игроков или рекламы.",
...
for (const locale of Object.keys(legalText) as Locale[]) {
  ...
  legalText[locale].privacy.sections.splice(-1, 0, {
    ...
    body: [metaPrivacyText[locale].body, metaCapiPrivacyText[locale]],
