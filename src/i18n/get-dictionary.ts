...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  fr: {
    ...
    countdown: { announcement: "Sortie le 4 novembre !", label: "WoW: Forever arrive dans", days: "jours", hours: "h", minutes: "min", seconds: "s", live: "C’est parti !" },
  },
  es: {
    ...en,
    ...
    countdown: { announcement: "¡Lanzamiento el 4 de noviembre!", label: "WoW: Forever llega en", days: "días", hours: "h", minutes: "min", seconds: "s", live: "¡Ya está aquí!" },
  },
  it: {
    ...en,
    ...
    countdown: { announcement: "In arrivo il 4 novembre!", label: "WoW: Forever arriva tra", days: "giorni", hours: "ore", minutes: "min", seconds: "sec", live: "È arrivato. Si parte!" },
  },
  pt: {
    ...en,
    ...
    countdown: { announcement: "Chega a 4 de novembro!", label: "WoW: Forever chega em", days: "dias", hours: "h", minutes: "min", seconds: "s", live: "Já chegou. Vamos a isso!" },
  },
  ru: {
    ...en,
    ...
    countdown: { announcement: "Выход 4 ноября!", label: "До выхода WoW: Forever", days: "дн.", hours: "ч", minutes: "мин", seconds: "сек", live: "Уже доступно. Вперёд!" },
  },
};
